...
public class JIFHorario extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jTblHorario.setToolTipText("");
        jTblHorario.setComponentPopupMenu(jPopupMenu1);
        jTblHorario.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jTblHorarioMouseClicked(evt);
            }
        });
    ...
    private void jTblHorarioMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTblHorarioMouseClicked
        filaSeleccionada();
    }//GEN-LAST:event_jTblHorarioMouseClicked
    ...
    private void eliminarHorario(){
        try {
           ...
           ul.setIdHorario(ud.obtenerIdHorario(String.valueOf(this.jTblHorario.getValueAt(jTblHorario.getSelectedRow(),1))));
            ...
            JOptionPane.showMessageDialog(null, "Error al eliminar el horario de la película: " + e);
        }
    }
